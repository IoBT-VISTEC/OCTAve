...
def run_octa500(
    ...
    from runsets.octa500.experiments.experiments import CSNetOCTA500ExperimentConfig, submit_csnet_experiment
    ...
    experimentations = CSNetOCTA500ExperimentConfig(
                ...
                if not _stop_flag and len(job_queue) < concurrency:
                    ...
                    try:
                        ...
                        while (not success) and retry > 0:
                            try:
                                job = executor.submit(submit_csnet_experiment, experiment, dry_run=dryrun)
                                success = True
