...
def run_octa500(
    train, prepare_data, seed, scribble_presence_ratio, num_epochs, experiment_start_index, experiment_end_index,
    ...
    from runsets.rose.experiments.experiments import ScribbleNetRoseFullyExperimentConfig, submit_scribblenet_experiment
    ...
    experimentations = ScribbleNetRoseFullyExperimentConfig(
