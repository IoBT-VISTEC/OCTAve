...
from runsets.dataclass import ScribbleNetExperimentModuleConfig

from experiments.octa.octa500.lightning import ScribbleNet


def train_scribblenet(
    experiment_config: ScribbleNetExperimentModuleConfig, experiment_name: str, fold: int, datamodule: RoseDatamodule,
