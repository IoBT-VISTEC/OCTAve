...
from experiments.octa.octa500.lightning import OCTA500Experiment3M_A


def train_octave(
    experiment_config: OCTAveExperimentModuleConfig, experiment_name: str, fold: int, datamodule: OCTA500Datamodule,
    ...
    experiment = OCTA500Experiment3M_A(**asdict(experiment_config))
