...
from runsets.dataclass import CECSNetExperimentModuleConfig

from experiments.octa.octa500.lightning import CSNetExperiment


def train_csnet(
    experiment_config: CECSNetExperimentModuleConfig, experiment_name: str, fold: int, datamodule: OCTA500Datamodule,
    ...
    experiment = CSNetExperiment(**asdict(experiment_config))
