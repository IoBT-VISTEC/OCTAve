...
from runsets.octa500.experiments.dataclass import UNetExperimentModuleConfig 

from experiments.octa.vanila.lightning import VanillaUnet


def train_unet(
    experiment_config: UNetExperimentModuleConfig, experiment_name: str, fold: int, datamodule: OCTA500Datamodule,
    ...
    experiment = VanillaUnet(**asdict(experiment_config))
