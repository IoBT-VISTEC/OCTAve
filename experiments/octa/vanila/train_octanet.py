...
from runsets.octa500.experiments.experiments import OCTAnetWeaklyOCTA500ExperimentConfig
...
@click.option('--weakly-supervise', is_flag=True, help='Switch to Weakly-Supervised Setting')
...
def run_octa500(
    train, prepare_data, seed, folds, scribble_presence_ratio, weakly_supervise, num_epochs, experiment_start_index, experiment_end_index,
    ...
    from runsets.octa500.experiments.experiments import OCTAnetOCTA500ExperimentConfig, submit_octanet_experiments
    ...
    if not weakly_supervise:
        experimentations = OCTAnetOCTA500ExperimentConfig(
        ...
        experimentations = OCTAnetWeaklyOCTA500ExperimentConfig(
            n_folds=folds, num_epochs=num_epochs,
            start_index=experiment_start_index, end_index=experiment_end_index,
            get_parallel_job=num_jobs_per_submit, base_logging_frequency=base_logging_frequency, scribble_presence_ratio=scribble_presence_ratio)
