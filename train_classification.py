...
def run_rose(
    train, seed, num_epochs, experiment_start_index, experiment_end_index, monitor,
    ...
    from runsets.classification.experiments.experiments import OCTAVEOCTA500ClassificationExperimentConfig, submit_octave_experiment
    ...
    experimentations = OCTAVEOCTA500ClassificationExperimentConfig(
        num_epochs=num_epochs, start_index=experiment_start_index,
        end_index=experiment_end_index,
        base_logging_frequency=base_logging_frequency)
